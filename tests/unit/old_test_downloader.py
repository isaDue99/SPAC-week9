...
class TestDownloader:
    ...
    def test_download_alt(self):
        ...
        d = Downloader()
        did_it_work = d.download(self.bad_url, self.output, self.url)
        assert did_it_work == True
    ...
    def test_download_bad_bad(self):
        """test that bad input AND bad alt input fails"""
        d = Downloader()
        did_it_work = d.download(self.bad_url, self.output, self.bad_url)
        assert did_it_work == False
